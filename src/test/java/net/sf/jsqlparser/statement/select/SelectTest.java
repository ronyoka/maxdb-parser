...
public class SelectTest {
    ...
    /**
     * Validates that a SELECT with FOR UPDATE WAIT <TIMEOUT> correctly sets a {@link Wait} with the correct timeout value.
     */
    @Test
    ...
    public void testIssue522_3() throws JSQLParserException {
        assertSqlCanBeParsedAndDeparsed(
            "SELECT CASE SIGN(mr.required_quantity) WHEN -1 * SIGN(mr.quantity_issued) THEN mr.required_quantity - mr.quantity_issued  ELSE 5 END quantity_open FROM mytable", true);
    }
