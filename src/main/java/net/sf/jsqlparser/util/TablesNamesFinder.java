...
public class TablesNamesFinder implements SelectVisitor, FromItemVisitor, ExpressionVisitor, ItemsListVisitor, SelectItemVisitor, StatementVisitor {
    ...
    /**
     * Initializes table names collector. Important is the usage of Column instances to find table names. This is only allowed for expression parsing, where a better place for tablenames could not be
     * there. For complete statements only from items are used to avoid some alias as tablenames.
     *
