...
public class CreateTable implements Statement {
  ...
  /**
   * A list of {@link Index}es (for example "PRIMARY KEY") of this table.<br> Indexes created with column definitions (as in mycol INT PRIMARY KEY) are not inserted into this list.
   */
